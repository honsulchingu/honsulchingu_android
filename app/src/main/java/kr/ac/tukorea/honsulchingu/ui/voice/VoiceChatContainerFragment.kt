 ...
 * Use the [VoiceChatContainerFragment.newInstance] factory method to
...
class VoiceChatContainerFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment VoiceChatContainerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            VoiceChatContainerFragment().apply {
